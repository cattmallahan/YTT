//OK go - this too shall pass - 23.14  28.79
           ...
           async function asyncCall3() {
                  ...
                  function controlToSlider(fromSlider, toSlider, toInput) {
                    ...
                    updatestartendtoslider(from, to);
                  ...
                  function updatestartendtoslider(from, to){
          ...
          function resolveAfter1Second() {
           ...
           async function asyncCall2() {
                  ...
                  function resetstart() {
                    let newstarttime = player.getCurrentTime();
                    console.log(newstarttime);
                    console.log(section.start);
                    section.start = (newstarttime - 0.10436075);
                    console.log(section.start);
                    //var duration = (section.end - section.start)/(rate) + difference;
                    //clearTimeout(timeout);
                    //timeout = setTimeout(restartVideoSection, duration * 1000);
                  ...
                  function resetend() {
                    let newendtime = player.getCurrentTime();
                    console.log(newendtime);
                    console.log(section.end);
                    section.end = (newendtime - 0.28982475);
                    console.log(section.end);
                    player.seekTo(section.end-.02);
                    //var duration = (section.end - section.start)/(rate) + difference;
                    //clearTimeout(timeout);
